...
export function renderResult(root, store) {
  ...
  root.append(
    ...
    h('div', { class: 'tablewrap' }, h('table', { class: 'files review' },
      h('thead', null, h('tr', null, h('th', { class: 'mark' }), h('th', { class: 'path' }, 'From'), h('th', { class: 'arrow' }), h('th', { class: 'path' }, 'To'), h('th', null, 'Outcome'))),
      tbody,
    )),
